 ...
 * @author admin
 */
@WebServlet(name = "CategoryRawTotalProduct", urlPatterns = {"/CategoryRaw/TotalProduct"})
public class CategoryRawTotalProduct extends HttpServlet {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            if(categoryRawId == null) {
                ...
                int editedProductQuantity = categoryRawService
                        .countProductRawInCategoryRaw(categoryRawId);
