 ...
 * @author admin
 */
@WebServlet(name = "CategoryRawNewProduct", urlPatterns = {"/CategoryRaw/NewProduct"})
public class CategoryRawNewProduct extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (PrintWriter out = resp.getWriter()) {
            ...
            if(categoryRawId == null) {
                ...
                int newProductQuantity = categoryRawService
                        .countNewProductInCategoryRaw(categoryRawId);
                
                out.append(newProductQuantity + "");
